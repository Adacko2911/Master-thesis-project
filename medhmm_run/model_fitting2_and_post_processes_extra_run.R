...
#==================================================================================================================================================================================================
    ...
    #simulated data
    sim_data<-readRDS(paste0("/gpfs/home1/adacko/data/three_state_design_mixed_dwell_2dep_final.rds"))
...
dwell_time_names<-rep("mix",5)
observation_lenght<-rep(500,5)
...
kappa <- function(mat) {
  ...
  true_emiss_mu_bar2<-c(60,30,10)
    ...
    true_dwell_var_bar<-c(log(exp_sigma2),log(exp_sigma3),log(exp_sigma4))
...
for(it in 1:cores){
  ...
  if(length(switch_pos_t)==length(switch_pos_est)){
    ...
    (length(switch_pos_t)>length(switch_pos_est)){
